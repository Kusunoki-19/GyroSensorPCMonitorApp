...
// #include "SerialDataStreamConverter.h"
#include "DataSerializer/SerialDataStreamConverter.h"
// #include "../DataSerializer/SerialDataStreamConverter.h"
...
float grad[3] = {0};
float angle[3] = {0};
unsigned long preMillTimeDate = 0;
...
void loop()
{
  ...
  //単位はdegree毎秒[degree/s].s
  AData[4] = (float)DData[4] / 131.072; // x角速度.
  AData[5] = (float)DData[5] / 131.072; // y角速度.
  AData[6] = (float)DData[6] / 131.072; // z角速度.

  //    Serial.print(" ACC[g]:  ");
  // Serial.print("accX:"); Serial.print(AData[0]);  // Serial.print("\t");
  // Serial.print("accY:"); Serial.print(AData[1]);  // Serial.print("\t");
  // Serial.print("accZ:"); Serial.print(AData[2]);  // Serial.print("\t");

  //    Serial.print("GYRO[deg/s]:  ");
  Serial.print("dataStart:");
  Serial.print("-");
  Serial.print(",");
  //    Serial.print("diffMs:"); Serial.print(millis() - preMillTimeDate); Serial.print(",");
  Serial.print("gx:");
  Serial.print(AData[4]);
  Serial.print(",");
  Serial.print("gy:");
  Serial.print(AData[5]);
  Serial.print(",");
  Serial.print("gz:");
  Serial.print(AData[6]);
  Serial.print(",");
